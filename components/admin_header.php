...
<div class="side-bar">
    ...
    <nav class="navbar">
        ...
        <a href="playlists.php"><i class="fas fa-stream"></i><span>playlists</span></a>
        ...
        <a href="../components/admin_logout.php" onclick="return confirm('logout from this website?');"><i class="fas fa-sign-out-alt"></i><span>logout</span></a>
    </nav>
</div>
